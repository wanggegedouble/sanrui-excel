...
import com.sanrui.plugs.excel.bean.CellBean;
import com.sanrui.plugs.excel.bean.GroupConfig;
import com.sanrui.plugs.excel.bean.TableBean;
import com.sanrui.plugs.excel.language.ILanguage;
import com.sanrui.plugs.excel.service.*;
...
public class TestExcel {
    ...
    public void testSimpleMapExport() throws Exception {
        ...
        service.doExport();
        FileOutputStream fos = new FileOutputStream("C:\\Users\\huawei\\Documents\\Java_project\\excel\\src\\main\\resources\\wy01.xls");
        workbook.write(fos);
        if(null != fos){
            fos.close();
        }
...
//        testTableExport();
//        workbook = new HSSFWorkbook(new FileInputStream("D:/tmp/test.xlsx"));
//        Sheet sheet = workbook.getSheet("testSimpleVoExport");
//        ImportExcelService tableService=new ImportExcelService(sheet);
...
//        System.out.print(read2);
    ...
    public void testVoHasListExport() throws Exception {
        ...
        FileOutputStream fos = new FileOutputStream("/Users/mac-pc/Projects/zhenghe/test-list.xls");
        workbook.write(fos);
        if(null != fos){
            fos.close();
        }
    ...
    public void testVoHasListVoExport() throws Exception {
        ...
        service.doExport();
        FileOutputStream fos = new FileOutputStream("/Users/mac-pc/Projects/zhenghe/test-vos.xls");
        workbook.write(fos);
        if(null != fos){
            fos.close();
        }
    ...
    public void testTableExport() throws Exception {
        ...
        FileOutputStream fos = new FileOutputStream("/Users/mac-pc/Projects/zhenghe/test-tab.xls");
        workbook.write(fos);
        if(null != fos){
            fos.close();
        }
...
//        testSimpleVoExport();
//        Sheet sheet = workbook.getSheet("testSimpleVoExport");
        workbook = new HSSFWorkbook(new FileInputStream("/Users/mac-pc/Projects/zhenghe/test0.xls"));
        Sheet sheet = workbook.getSheet("testSimpleVoExport");
        ...
        FileOutputStream fos = new FileOutputStream("/Users/mac-pc/Projects/zhenghe/test00.xls");
        workbook.write(fos);
        if(null != fos){
            fos.close();
        }
